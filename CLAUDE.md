...
|---|---|---|---|
| `mcp_server_auto_start` | bool | `False` | GUI checkbox or `context.set_setting(...)` |
| `port` | int | `7891` | GUI port spinner |
| `mcp_server_file_io_base_dir` | str or None | `None` (unrestricted) | GUI browse field or `context.set_setting(...)` |
| `mcp_server_file_io_allowed_extensions` | list[str] | see `_DEFAULT_EXTENSIONS` | `set_file_io_config` MCP tool or `context.set_setting(...)` |
